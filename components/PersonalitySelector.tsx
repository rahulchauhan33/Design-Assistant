    ...
    <div id="personality-selector" className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4 w-full" role="tablist" aria-label="Select a personality">
      {PERSONALITIES.map((p, index) => {
        ...
        return (
          ...
          >
            <p.icon className={`h-8 w-8 md:h-12 md:w-12 mb-2 md:mb-3 transition-colors ${isActive ? 'text-[#69961a] dark:text-[#ABF62D]' : 'text-gray-600 dark:text-gray-500'}`} aria-hidden="true" />
